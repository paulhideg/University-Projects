...
class UI:
    ...
    def shortest_backwards_bfs(self):
        startVertex = int(input("Start vertex: "))
        endVertex = int(input("End vertex: "))
        pathAndDistance = self.graph.getShortestPath(startVertex, endVertex)
    ...
    def start(self):
        commands = {"1": self.empty_graph,
                    ...
                    "20": self.read_file,
                    "21": self.write_file,
                    "22": self.shortest_backwards_bfs}
        while True:
            ...
            print("22. Gets the shortest backwards bfs path between 2 vertices")
            print("0. Exit")
            cmd = input("> ")
            if cmd in commands:
                commands[cmd]()
