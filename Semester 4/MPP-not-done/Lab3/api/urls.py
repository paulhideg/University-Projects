...
from .views import BookView, GenreView, LibraryView, BorrowedView, ReaderView, AddressView, GenreStatsView, BookStatsView, LibraryBooksView, AddressLibraryView, GenreBooksView, BookBorrowsView, ReaderBorrowsView, BookReadersView, BorrowedBooksView, GenresView2
...
urlpatterns = [
    ...
    path('genres2/', GenresView2.as_view(), name='genres2')
]
